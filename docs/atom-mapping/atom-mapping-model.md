...
- [Atom Mapping](/docs/atom-mapping-model#atom-mapping)
- [Identifier](/docs/atom-mapping-model#identifier)
- [Name](/docs/atom-mapping-model#name)
- [Substrates](/docs/atom-mapping-model#substrates)
- [Products](/docs/atom-mapping-model#products)
- [Curated](/docs/atom-mapping-model#curated)
...
### Identifier
The identifier columns displays a [Reaction](/docs/reaction) link. If no reaction identifier was given or none was found the field is empty. The table can be sorted by identifier.
...
### Substrates
The substrates column shows all the given substrate metabolites quantity and names. Additionally if a metabolite id was identified a link to the [Metabolite](/docs/metabolite) page will be established.

### Products
Products effectively function like [Substrates](/docs/atom-mapping-model#substrates).
